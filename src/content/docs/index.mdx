...
hero:
  tagline: SplashKit is a beginner's all-purpose software toolkit. This is very awesome!
  image:
    file: ../../assets/box.webp
  actions:
    - text: Documentation
      link: /splashkit.io-starlight/api/
      icon: document
      variant: primary
    - text: Article & Guides
      link: /splashkit.io-starlight/guides/
      icon: open-book
      variant: minimal
    - text: Usage Examples
      link: /splashkit.io-starlight/usage-examples/
      icon: rocket
      variant: secondary
---
...
<center>See the [Installation Guides](/splashkit.io-starlight/installation/) for more details.</center>
